...
} & import("../../utils/native-props").NativeProps<"--border-radius" | "--height" | "--width" | "--slide-width" | "--slide-height" | "--track-padding" | "--track-offset"> & import("react").RefAttributes<import("./swiper").SwiperRef>> & {
