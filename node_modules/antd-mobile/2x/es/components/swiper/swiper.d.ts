...
} & NativeProps<'--height' | '--width' | '--slide-width' | '--slide-height' | '--border-radius' | '--track-padding' | '--track-offset'>;
...
} & NativeProps<"--border-radius" | "--height" | "--width" | "--slide-width" | "--slide-height" | "--track-padding" | "--track-offset"> & React.RefAttributes<SwiperRef>>;
